...
files = dir('C:\Users\Jason Rihel\Desktop\Documents\Perl Batch Folder2\Files to Run');
tic
...
copyfile(strcat('C:\Users\Jason Rihel\Desktop\Documents\Perl Batch Folder2\Files to Run\',files(i).name),strcat('C:\Users\Jason Rihel\Desktop\Documents\Perl Batch Folder2\',files(i).name(1:end-3),'txt'))
status = dos(strcat('two_camera_v96.bat "',files(i).name(1:end-3),'txt"'))

   if strcat(files(i).name(10)) == '_'
    movefile(strcat('C:\Users\Jason Rihel\Desktop\Documents\Perl Batch Folder2\',files(i).name(1:end-3),'txt.first_96h_middur.txt'),strcat('C:\Users\Jason Rihel\Desktop\Documents\Perl Batch Folder2\output\',files(i).name(1:10),'DATA.txt'))
    movefile(strcat('C:\Users\Jason Rihel\Desktop\Documents\Perl Batch Folder2\',files(i).name(1:end-3),'txt.last_96h_middur.txt'),strcat('C:\Users\Jason Rihel\Desktop\Documents\Perl Batch Folder2\output\',files(i).name(1:7),files(i).name(11:12),'_DATA.txt'))
    end

    if strcat(files(i).name(10)) == 'p'
    movefile(strcat('C:\Users\Jason Rihel\Desktop\Documents\Perl Batch Folder2\',files(i).name(1:end-3),'txt.first_96h_middur.txt'),strcat('C:\Users\Jason Rihel\Desktop\Documents\Perl Batch Folder2\output\',files(i).name(1:11),'DATA.txt'))
    movefile(strcat('C:\Users\Jason Rihel\Desktop\Documents\Perl Batch Folder2\',files(i).name(1:end-3),'txt.last_96h_middur.txt'),strcat('C:\Users\Jason Rihel\Desktop\Documents\Perl Batch Folder2\output\',files(i).name(1:7),files(i).name(12:14),'_DATA.txt'))
    end
...
movefile(strcat('C:\Users\Jason Rihel\Desktop\Documents\Perl Batch Folder2\',files(i).name(1:end-4),'_middur.txt'),strcat('C:\Users\Jason Rihel\Desktop\Documents\Perl Batch Folder2\output\',files(i).name(1:9),'_DATA.txt'))
end

if strcat(files(i).name(10)) == 'p'
movefile(strcat('C:\Users\Jason Rihel\Desktop\Documents\Perl Batch Folder2\',files(i).name(1:end-4),'_middur.txt'),strcat('C:\Users\Jason Rihel\Desktop\Documents\Perl Batch Folder2\output\',files(i).name(1:10),'_DATA.txt'))
end
...
for i = 1:length(files); 
   ...
   if files(i).isdir == 0;
    movefile(strcat('C:\Users\Jason Rihel\Desktop\Documents\Perl Batch Folder2\Files to Run\',files(i).name),strcat('C:\Users\Jason Rihel\Desktop\Documents\Perl Batch Folder2\Files Ran\',files(i).name))
    end
end
